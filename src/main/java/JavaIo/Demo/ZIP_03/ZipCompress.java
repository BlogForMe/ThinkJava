...
public class ZipCompress {
    public static void main(String[] args) throws IOException {
        FileOutputStream f = new FileOutputStream(Constants.writePathU + "test.zip");
        CheckedOutputStream csum = new CheckedOutputStream(f, new Adler32());
        ZipOutputStream zos = new ZipOutputStream(csum);
        BufferedOutputStream out = new BufferedOutputStream(zos);
        zos.setComment("A test of Java Zipping");

        args = new String[]{Constants.writePathU + "test.zip"};
        ...
        FileInputStream fi = new FileInputStream(Constants.writePathU + "test.zip");
        ...
        ZipFile zf = new ZipFile(Constants.writePathU + "test.zip");
