...
public class Worm implements Serializable {
    ...
    public static void main(String[] args) throws ClassNotFoundException, IOException {
        ...
        ObjectOutputStream out = new ObjectOutputStream(new FileOutputStream(JavaIo.Utils.Constants.writePathU + "worm.out"));
        out.writeObject("Worm storage\n");
        out.writeObject(w);
        out.close(); //Also flushes output
        ObjectInputStream in = new ObjectInputStream(new FileInputStream(JavaIo.Utils.Constants.writePathU + "worm.out"));
