...
public class TextFile extends ArrayList<String> {
    ...
    public static void main(String[] args) {
        String file = read(thinkjava.JavaIo.Utils.Constants.hPBasic + "TextFile.java");
        ...
        TreeSet<String> words = new TreeSet<>(new TextFile(thinkjava.JavaIo.Utils.Constants.hPBasic + "TextFile.java", "\\W+"));
